...
export function AnswerEditor({
  ...
  return (
    <Card className="flex h-full min-h-0 flex-col gap-3 overflow-hidden p-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h3 className="text-base font-semibold text-toss-text">답안 작성</h3>
          <p className="mt-1 text-sm text-toss-muted">입력 즉시 자동 저장됩니다.</p>
        </div>
      ...
      <textarea
        ...
        className="min-h-0 flex-1 rounded-xl border border-gray-200 px-4 py-3 text-sm leading-relaxed text-toss-text outline-none transition-all duration-200 placeholder:text-gray-400 focus:border-blue-200 focus:ring-2 focus:ring-[#3182F6]"
      />
